        ...
        <BrowserRouter>
          <Routes>
            <Route element={<PageLayout />}>
              ...
              <Route path="settings/plugins" element={<PageRoute title={["Settings", "Plugins"]}><PluginsPage /></PageRoute>} />
              <Route path="settings/config" element={<PageRoute title={[{label: "Settings", path: "/settings"}, "config"]}><SettingsPage /></PageRoute>} />
